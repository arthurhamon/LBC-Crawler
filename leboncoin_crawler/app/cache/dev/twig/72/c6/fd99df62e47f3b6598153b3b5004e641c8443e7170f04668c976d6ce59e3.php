...
\t\t\t\t\t\t<h3><a class=\"ad_link\" href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("crawlerlbccrawler_detail", array("id" => $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "id"))), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t<p>";
            // line 24
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "city"), "html", null, true);
            echo " - ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "zip"), "html", null, true);
            echo "</p>
\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t<span class=\"btn btn-primary\">";
            // line 26
            echo twig_escape_filter($this->env, $this->env->getExtension('lbc_extension')->priceFilter($this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "price")), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t<a class=\"btn btn-danger\" role=\"button\" href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("crawlerlbccrawler_remove", array("id" => $this->getAttribute((isset($context["ad"]) ? $context["ad"] : $this->getContext($context, "ad")), "id"))), "html", null, true);
            echo "\">Remove</a>
\t\t\t\t\t\t</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
...
\t\t";
            // line 36
            if ((0 == (isset($context["compt"]) ? $context["compt"] : $this->getContext($context, "compt")) % 5)) {
                // line 37
                echo "\t\t\t</div>
\t\t\t";
                // line 38
...
\t\t";
            // line 41
            if (((0 == (isset($context["compt"]) ? $context["compt"] : $this->getContext($context, "compt")) % 5) && ($this->getAttribute((isset($context["loop"]) ? $context["loop"] : $this->getContext($context, "loop")), "last") == false))) {
                // line 42
                echo "\t\t\t<div class=\"row\">
\t\t";
            } elseif (($this->getAttribute((isset($context["loop"]) ? $context["loop"] : $this->getContext($context, "loop")), "last") == true)) {
                // line 44
                echo "\t\t\t</div>
\t\t\t";
                // line 45
